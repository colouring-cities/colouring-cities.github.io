...
The CCRP is a branded research programme in which international academic institutions already involved in building stock researchcome together to pool knowledge, and co-work on and test open-source codefor Colouring Cities platforms. Each CCRP platform is managed and funded independently by academic partner at country level, and follows an agreed set of [CCRP protocols](https://github.com/colouring-cities/manual/wiki/B.-International-research-partners;-links,-resources,-protocols-&-meeting-dates) drafted by the Alan Turing Institute. Academic and stakeholder networks are also developed at country level to facilitate collaborative maintenance of national or regional databases by local stakeholders. The CCRP releases its core code, and additional country specific code, via GitHub. Its standardised open building attribute datasets are accessible via its international platform network. 
