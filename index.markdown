...
## Overview
The Colouring Cities Research Programme (CCRP) is an open data initiative that designs and tests open-source tools to facilitate the sharing of standardised spatial data  on national building stocks across countries. The aim is to increase access to big data on stocks and support analysis of data across countries to meet UN Sustainble Development Goals. The programme brings together information on buildings - held within academia, industry, government, the third sector, and communities, and within science and technology, and the humanities and arts - to help society collectively solve complex urban problems. It does this through the co-creation and collaborative management of research-led, networked, open data platforms that visualise and release comprehensive open data on stock composition, performance, and dynamic behaviour.

## Oversight
The CCRP is a branded research-led programme that enables international academic institutions to pool knowledge and resources, and co-develop and test open-source code for Colouring Cities platforms. Over 100 researchers worldwide have contributed to the project to date. The CCRP is managed by the Alan Turing Institute (the UK's National Institute of Data Science and Artificial Intelligence), and draws from the computer science and AI pioneer Alan Turing's philosophy that "_the isolated individual does not develop any intellectual power  …The search for new techniques must be regarded as carried out by the human community as a whole, rather than by individuals_". The initiative was previously based at the Centre for Advanced Spatial Analysis, University College London where the [Colouring London]( https://colouringlondon.org/) prototype was built. The CCRP academic network currently consists of academic partners in Australia, Bahrain, Britain, Canada, Colombia, Germany, Greece, Indonesia, Lebanon and Sweden, with collaborations in  Switzerland, the US and Austria also underway. 

## International Academic Steering Group

Owing to growing interest in the CCRP, CCRP Global Region Hubs are now beginning to be developed with academic partners, with the CCRP's European Hub, led by Leibniz institute for Ecological & Urban Regional Development, the first to be launched. The purpose of Hubs is to help encourage and manage wider academic participation and to stimulate interdisciplinary/cross sector collaboration on building stock research. Strategies for CCRP global hub rollout are guided by the CCRP's International Academic Steering Group. This is an informal collaboration of CCRP academic partners actively involved in hub development. The Group is chaired by the Alan Turing Institute and involves academic institutions currently leading on Global Region Hubs from: the City Futures Research Center, University of New South Wales (Colouring Australia/Asia Pacific hub); the Canada Excellence Research Chair in Smart, Sustainable and Resilient Communities and Cities at Concordia University (Colouring Canada/North American hub) and the Research Data Centre at the Leibniz institute for Ecological & Urban Regional Development -IOER Dresden (Colouring Germany/European Hub). Concordia University also chairs the CCRP's monthly international engineering meeting where engineers from partner countries co-work on code. IOER Dresden is leading on the CCRP's 2024 workshop series.
