...
The Colouring Cities Research Programme (CCRP) designs and tests open tools that facilitate knowledge and data sharing on the composition, performance and dynamics of building stocks, across sectors, disciplines and countries. The CCRP is run by the [Alan Turing Institute](https://www.turing.ac.uk/about-us), the UK's National Institute of Data Science and Artificial Intelligence which was set up to make great leaps in data science and artificial intelligence research in order to change the world for the better. 

Colouring Cities platforms are specifically designed to effect a step change in the range, scale, quality and accessibility of building level, spatial building attribute data:
...
* to support AI applications that provide insights into the stock as a complex dynamic system, and iunderlying rules, patterns and cycles operating in stocks that impact on sustainable trajectories; 
* to engage diverse stakeholders in the process of knowledge exchange through colour and through diverse data capture methods;
* to develop and test an academic governance model for independently managed, networked platforms able to collectively deliver a global building database able to supporting building atttribute data analysis and comparison across countries 

The CCRP is a branded research programme that brings together researchers already involved in building stock research, from across countries to pool knowledge, and co-work on and test open-source code,for Colouring Cities platforms. Each CCRP platform is managed and funded independently by each academic partner or academic consortium, at country level, and follows an agreed set of [CCRP protocols](https://github.com/colouring-cities/manual/wiki/B.-International-research-partners;-links,-resources,-protocols-&-meeting-dates) drafted by the Alan Turing Institute. The CCRP releases its core code, and additional country specific code, via GitHub. Its standardised open building attribute datasets are accessible via its international platform network. The CCRP also promotes ethical, reproducible, and collaborative data science, as set out in [The Turing Way](https://the-turing-way.netlify.app/welcome.htmlsupport).
