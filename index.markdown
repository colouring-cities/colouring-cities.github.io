...
* to increase access to volume data required to exploit the potential of AI to gain rapid insights into the stock as a complex dynamic system;
* to test an academic governance model for a global network of low-cost, interoperable but independently managed open data platfoms whose standardised, building level datasets allow for comparative analysis of stocks at global scale;
* to test diverse data capture methods, and feedback loops to engage diverse stakeholders -from industry, academia, government, the third sector, and citizens- required to maximise the data accuracy, granularity, range and geographic cover; 
