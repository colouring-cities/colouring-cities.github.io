...
* to support AI applications that provide insights into the stock as a complex dynamic system, and to identify underlying rules, patterns and cycles operating in stocks ,that lead to sustainable and unssustainable, trajectories;
...
* to  atest the use iof  colour and feedback loops between computational approaches and crowdsourcing methods to engage diverse stakeholders in the process of platform development to maximise the accuracy, granularity, range and geographic coverage of data 
