...
## Overview
Buildings are where we spend most of our lives and most of our money and from where around 40% of global energy emissions derive. Building stocks are also the most significant socio-cultural and economic resource within cities and their largest capital asset.

Comprehensive spatial data on the composition, operation, and the dynamic behaviour of buildings stocks are now urgently required to help diverse stakeholders - in government, academia, industry, the third sector, and citizens - to work colleactively to improve national stock quality, efficiency, sustainability and resilience.

However in many countries cpmprehensive spatial information on buildings, at building level, is extremely difficult to obtain; often being highly fragmented, restricted, missing, or only available in aggregated form. This situation is now severly hampering efforts to meet national sustainability targets. 

The Colouring Cities Research Programme (CCRP) is a research-led open source initiative that has been set up to drive a step-change in access to high quality standardised comprehensive microspatial building data across countries, to accelerate the move to Net Zero and UN Sustainable Development Goals.  

The CCRP does this through a simple data sharing model that allows academic research teams to manage national open databases on stocks, and to easily and quickly pool and share relevant expertise, ideas and resources across countries and co-work in an exceptional efficient way.

Over 100 researchers worldwide have voluntarily contributed to the project to date, with over 60 acdemics currently involved. The CCRP network currently consists of academic partners in Australia, Bahrain, Britain, Canada, Colombia, Germany, Greece, Indonesia, Lebanon and Sweden, with exploratory work the US and Austria also underway.

The CCRP collects, collates, verifies and releases open data on buildings, held by academia, industry, government, the third sector, and communities, to help society collectively solve complex urban problems. It does this through the co-creation and collaborative management of research-led, networked, easy-to-maintain, open data platforms that work to visualise and release over a 100 comprehensive microspatial open datasets on stock composition, performance, and dynamic behaviour.
