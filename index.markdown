...
The Colouring Cities Research Programme (CCRP) creates and tests open tools to facilitate knowledge and data sharing on the composition, performance and dynamics of building stocks - across sectors, disciplines and countries. The CCRP is run by the [Alan Turing Institute](https://www.turing.ac.uk/about-us), the UK's National Institute of Data Science and Artificial Intelligence whose purpose is is to make great leaps in data science and artificial intelligence research to change the world for the better. 

[Alan Turing](https://www.turing.ac.uk/blog/what-alan-turing-means-us) argued that "_the isolated individual does not develop any intellectual power  …The search for new techniques must be regarded as carried out by the human community as a whole, rather than by individuals_".  The CCRP programme brings together collaborators from across sectors, communities and countries, and from science, the humanities and the arts to help solve complex problems relating to cities and to building stocks through the development of open data visualisation platfoms and databases. It looks to capture knowledge from as many individuals and organisations as possible involved in the practical design, construction, management, monitoring, conservation, retrofitting, from citizens using/living in buildings, as well as from many areas of academic research. These include data science, computer science and software engineering, urban science, industrial ecology, urban morphology, physics, environmental science, material science, climate change resilience, building construction, engineering, conservation, housing, planning, architecture, history, architectural history, graphic design and colour theory, as well as into open data models, data ethics, artificial intelligence, including machine learning & computer vision, procedural modelling, the mathematics of cities, and GIS and spatial data visualisation.

Colouring Cities platforms are specifically designed to effect a step change in the range, scale, quality and accessibility of spatial building attribute data at building level in order to:
* help improve stock quality, sustainability, efficiency and resilience in line with the [United Nations' [Sustainable Development Goals](https://sdgs.un.org/goals) and [New Urban Agenda](https://habitat3.org/the-new-urban-agenda/);
* support AI applications that provide insights into the stock as a complex dynamic system, and to identify underlying rules, patterns and cycles operating in stocks ,that lead to sustainable and unssustainable, trajectories;
* develop and test an academic governance model for independently managed, networked platforms able to collectively deliver a global building database able to supporting building atttribute data analysis and comparison across countries 
* test the use if colour and of feedback loops between computational approaches and crowdsourcing methods to engage diverse stakeholders from industry, academia, government, the third secto and citizens in the process of platform development to maximise the accuracy, granularity, range and geographic coverage of data 
...
The CCRP is a branded research programme allowing international institutions involved in building stock research, and research software engineering, to come together to pool knowledge, and co-develop and test open-source code for Colouring Cities platforms. Each CCRP platform is managed and funded independently by academic partners at country level, and follows an agreed set of [CCRP protocols](https://github.com/colouring-cities/manual/wiki/B.-International-research-partners;-links,-resources,-protocols-&-meeting-dates) drafted by the Alan Turing Institute. Stakeholder networks are then developed within countries to maximise efficiency through collaborative maintenance systems involving contributions from diverse stakeholders. The CCRP releases its core code, and additional country specific code, via GitHub. Its standardised open building attribute datasets are accessible via its international platform network. 
...
CCRP research partners can be identified by their exclusive use of the Colouring Cities logo, and their inclusion on this page, and n the [Alan Turing Institute CCRP webpage](https://www.turing.ac.uk/research/research-projects/colouring-london-and-colouring-cities-research-programme).  No other applications of Colouring Cities code, interface design or logo are endorsed by the Alan Turing Institute. Information on CCRP resources provided by The Alan Turing Insititute and Academic Partner Protocols can be found [here](https://github.com/colouring-cities/manual/wiki/B.-CCRP-INTERNATIONAL-RESEARCH-PARTNERS-;-links,-resources,-protocols-&-meeting-dates).
